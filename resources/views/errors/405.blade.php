...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <div class="mt-3">
      <img src="{{asset('assets/img/illustrations/girl-with-laptop-light.png')}}" alt="girl-with-laptop-light.png" width="500" class="img-fluid"  data-app-light-img="illustrations/girl-with-laptop-light.png" data-app-dark-img="illustrations/girl-with-laptop-dark.png">
    </div>
  </div>
</div>
<!-- /Error -->
